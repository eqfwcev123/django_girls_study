...
from blog.views import post_list, post_detail, post_add, post_delete, post_delete_confirm, post_edit
...
urlpatterns = [
    ...
    path('posts/<int:pk>/delete/confirm/', post_delete_confirm, name='url-post-delete-confirm'),
